...
const aumentarQuantidade = document.querySelectorAll('[data-aumentar-quantidade]');
...
const diminuirQuantidade = document.querySelectorAll('[data-diminuir-quantidade]')
